...
class SecurityTestPipeline:
    ...
    Runs a batch of attack prompts, classifies each result,
    calculates security metrics, and generates a formatted report.
    Reusable against any agent — just swap agent/runner.
